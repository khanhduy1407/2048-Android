...
import com.nkduy.n2048.activities.helper.BaseActivity;
...
public class MainActivity extends BaseActivity{
    ...
    private final boolean[] gameResumeable = new boolean[] {
            false,
            false,
            false,
            false
    ...
    public class MyViewPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            switch (position) {
                case 0:
                    imageView = findViewById(R.id.main_menu_img1);
                    ...
                    break;
                case 1:
                    imageView = findViewById(R.id.main_menu_img2);
                    if (PreferenceManager.getDefaultSharedPreferences(MainActivity.this).getString("pref_color","1").equals("1"))
                    ...
                    break;
                case 2:
                    imageView = findViewById(R.id.main_menu_img3);
                    if (PreferenceManager.getDefaultSharedPreferences(MainActivity.this).getString("pref_color","1").equals("1"))
                    ...
                    break;
                case 3:
                    imageView = findViewById(R.id.main_menu_img4);
                    if (PreferenceManager.getDefaultSharedPreferences(MainActivity.this).getString("pref_color","1").equals("1"))
