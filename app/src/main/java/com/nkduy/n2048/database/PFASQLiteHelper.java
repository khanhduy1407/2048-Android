...
public class PFASQLiteHelper extends SQLiteOpenHelper {
     ...
     */
    public static final String DATABASE_NAME = "NKD_2048_DB";
    ...
    public int updateSampleData(PFASampleDataType sampleData) {
        ...
        return database.update(TABLE_SAMPLEDATA, values, KEY_ID + " = ?", new String[] { String.valueOf(sampleData.getID()) });
    }
    ...
    public void deleteSampleData(PFASampleDataType sampleData) {
        SQLiteDatabase database = this.getWritableDatabase();
        database.delete(TABLE_SAMPLEDATA, KEY_ID + " = ?", new String[] { Integer.toString(sampleData.getID()) });
